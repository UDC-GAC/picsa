...
module "s3_to_rds_pandas_dag" {
  ...
  bucket_id    = "picsa-orquestador-airflow-${var.env}"
  files_key    = "dags/etl_s3_to_rds/etl_s3_to_rds.py"
  files_source = "../../../../dags/etl_s3_to_rds/etl_s3_to_rds.py"
  files_etag   = filemd5("../../../../dags/etl_s3_to_rds/etl_s3_to_rds.py")
}

module "s3_to_rds_pandas_raw_data_files" {
  source = "../../modules/s3_objects"

  for_each     = fileset("../../../../dags/etl_s3_to_rds/raw_data", "*.csv")
  bucket_id    = module.raw_data_bucket.bucket_id
  files_key    = "etl_s3_to_rds/raw_data/${each.value}"
  files_source = "../../../../dags/etl_s3_to_rds/raw_data/${each.value}"
  files_etag   = filemd5("../../../../dags/etl_s3_to_rds/raw_data/${each.value}")
}
...
module "s3_to_rds_pandas_requirements" {
  ...
  bucket_id    = "picsa-orquestador-airflow-${var.env}"
  files_key    = "requirements/etl_s3_to_rds/requirements.txt"
  files_source = "../../../../dags/etl_s3_to_rds/requirements.txt"
  files_etag   = filemd5("../../../../dags/etl_s3_to_rds/requirements.txt")
}
